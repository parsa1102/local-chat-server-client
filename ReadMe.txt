1. run only one instance of server

2. from there you can open as many instances of client as you want
...
with the memory location of the socket that has connected with the date and time
 of connection
